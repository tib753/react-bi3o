...
const translatePackageLimit = (value) => {
    ...
    >
      ...
      <InnerDiv>
        <Box textAlign="center">
          ...
          <PlanItemDayCount>
            {t("{{days}} Days", { days: item?.validity ?? "" })}
          </PlanItemDayCount>
        </Box>
        <PlanItemInfoList>
          <PlanItemInfoListItem>
            ...
            />
            <span>
              {t("Max order")} ({translatePackageLimit(item?.max_order)})
            </span>
          </PlanItemInfoListItem>
          <PlanItemInfoListItem>
            <CheckCircleIcon
            ...
            <span>
              {" "}
              {t("Max product")} ({translatePackageLimit(item?.max_product)})
            </span>
          </PlanItemInfoListItem>
          {item?.pos === 1 && (
            <PlanItemInfoListItem>
