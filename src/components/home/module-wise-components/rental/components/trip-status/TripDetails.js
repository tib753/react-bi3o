          ...
          <Grid item xs={12} lg={6}>
            ...
            >
              ...
              >
                ...
                >
                  {tripDetails?.trip_type === "day_wise"
                    ? t("Day wise")
                    : t(tripDetails?.trip_type?.replace("_", " "))}
                </Typography>
                {tripDetails?.estimated_hours > 0 && tripDetails?.trip_type === "hourly" && (
                  ...
                  >
                    {t("Estimated")} {tripDetails?.estimated_hours} {t("hr")}
                  </Typography>
                )}
                {tripDetails?.estimated_hours > 0 && tripDetails?.trip_type === "day_wise" && (
                  ...
                  >
                    {t("Estimated")} {tripDetails?.estimated_hours/24} {t("Days")}
                  </Typography>
                )}
